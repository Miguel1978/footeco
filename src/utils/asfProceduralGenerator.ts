...
export function generateAsfSessionProcedural(params: ProceduralSessionParams) {
  ...
  const coach1 = coach ? coach.split(' ')[0] : 'Miguel';
  const coach2 = assistantCoach ? assistantCoach.split(' ')[0] : 'SEB';
    ...
    dribble: [
      {
        ...
        finalGame: {
          ...
          focus: "Focus TE/TA",
          duration: "30 min",
          description: `Match officiel FootEco 7 contre 7 (7v7) : Tout but inscrit immédiatement après un duel 1c1 gagné compte triple !\nActivité remplaçants : Défi jonglage pieds alternés et travail de dextérité semelle.`,
          drawing1Caption: "Match 7v7 FootEco valorisation duels 1c1",
          drawing1Coach: "",
          drawing2Caption: "",
          drawing2Coach: "",
      ...
      },
      {
        ...
        finalGame: {
          ...
          focus: "Focus TE/TA",
          duration: "30 min",
          description: `Match 7 contre 7 (7v7) : Deux couloirs latéraux de 5m protégés où seul le 1c1 est autorisé. Tout franchissement de ligne en dribble rapporte 1 point bonus.\nActivité remplaçants : Slalom en 8 et travail semelle/coup de pied.`,
          drawing1Caption: "Match 7v7 avec couloirs de percussion",
          drawing1Coach: "",
          drawing2Caption: "",
          drawing2Coach: "",
          recommendedPreset1: "preset-game-7v7",
    ...
    tir: [
      {
        ...
        finalGame: {
          ...
          focus: "Focus TE/TA",
          duration: "30 min",
          description: `Match d'application officiel 7 contre 7 (7v7) avec grands buts et 2 gardiens. Règle : But marqué en 1 touche de balle = 2 points. Tout tir non cadré donne une touche immédiate à l'adversaire.\nRemplaçants : Jonglage de la tête et tirs de précision sur cibles.`,
          drawing1Caption: "Match 7v7 FootEco avec 2 gardiens de but",
          drawing1Coach: "",
          drawing2Caption: "",
          drawing2Coach: "",
          recommendedPreset1: "preset-game-7v7",
      ...
      },
      {
        ...
        finalGame: {
          ...
          focus: "Focus TE/TA",
          duration: "30 min",
          description: `Match 7 contre 7 (7v7) avec zones franches de tir : tout but inscrit d'en dehors de la surface vaut 2 points, tout but en 1 touche dans la surface vaut 3 points.\nActivité remplaçants : Tir de précision sur bâche avec cibles dans les lucarnes.`,
          drawing1Caption: "Match 7v7 avec bonus tirs lointains & 1 touche",
          drawing1Coach: "",
          drawing2Caption: "",
          drawing2Coach: "",
          recommendedPreset1: "preset-game-7v7",
    ...
    defense: [
      {
        ...
        finalGame: {
          ...
          focus: "Focus TE/TA",
          duration: "30 min",
          description: `Match 7 contre 7 (7v7) : Récupérer le ballon dans la moitié de terrain adverse et marquer en moins de 6 secondes donne 3 points.\nActivité remplaçants : Atelier gainage dynamique avec ballon et têtes défensives.`,
          drawing1Caption: "Match 7v7 avec bonus récupération haute",
          drawing1Coach: "",
          drawing2Caption: "",
          drawing2Coach: "",
          recommendedPreset1: "preset-game-7v7",
    ...
    transition: [
      {
        ...
        finalGame: {
          ...
          focus: "Focus TE/TA",
          duration: "30 min",
          description: `Match 7 contre 7 (7v7) : But marqué après transition offensive en moins de 6 secondes compte double. Si l'équipe qui a perdu la balle la récupère dans les 3 secondes, elle obtient un penalty pédagogique.\nActivité remplaçants : Devoirs techniques individualisés en jonglage dynamique.`,
          drawing1Caption: "Match 7v7 Règle ASF des 3 secondes",
          drawing1Coach: "",
          drawing2Caption: "",
          drawing2Coach: "",
          recommendedPreset1: "preset-game-7v7",
    ...
    tactique: [
      {
        ...
        finalGame: {
          ...
          focus: "Focus TE/TA",
          duration: "30 min",
          description: `Match officiel FootEco 7 contre 7 (7v7) : But inscrit après une relance partie du gardien et au moins 4 passes réussies vaut 3 points.\nActivité remplaçants : Devoirs techniques par postes (défenseurs : passes longues brossées, ailiers : centres).`,
          drawing1Caption: "Match 7v7 avec valorisation de la relance",
          drawing1Coach: "",
          drawing2Caption: "",
          drawing2Coach: "",
          recommendedPreset1: "preset-game-7v7",
    ...
    technique: [
      {
        ...
        finalGame: {
          ...
          focus: "Focus TE/TA",
          duration: "30 min",
          description: `Match 7 contre 7 (7v7) FootEco : Tout joueur touchant le ballon plus de 3 fois d'affilée concède un coup franc indirect (règle des 3 touches max).\nActivité remplaçants : Défi jonglage pied faible et défis techniques individualisés.`,
          drawing1Caption: "Match 7v7 FootEco en 3 touches de balle max",
          drawing1Coach: "",
          drawing2Caption: "",
          drawing2Coach: "",
          recommendedPreset1: "preset-game-7v7",
      ...
      },
      {
        ...
        finalGame: {
          ...
          focus: "Focus TE/TA",
          duration: "30 min",
          description: `Match officiel FootEco 7 contre 7 (7v7) : But inscrit du pied faible validé à 3 points. Tout joueur réussissant un une-deux pied faible débloque une supériorité temporaire.\nActivité remplaçants : Défi jonglage pied faible exclusif.`,
          drawing1Caption: "Match 7v7 FootEco valorisation du pied faible",
          drawing1Coach: "",
          drawing2Caption: "",
          drawing2Coach: "",
          recommendedPreset1: "preset-game-7v7",
    ...
    centres: [
      {
        ...
        finalGame: {
          ...
          focus: "Focus TE/TA",
          duration: "30 min",
          description: `Match 7 contre 7 (7v7) : Tout but marqué sur un centre en 1 touche de balle (tête, volée, plat du pied) rapporte 3 points.\nActivité remplaçants : Ateliers de volées acrobatiques et précision de centres au jalon.`,
          drawing1Caption: "Match 7v7 avec bonus buts sur centres",
          drawing1Coach: "",
          drawing2Caption: "",
          drawing2Coach: "",
          recommendedPreset1: "preset-game-7v7",
  ...
  if (safeVariation === 'intensity' || safeVariation.includes('intens')) {
    ...
    result.finalGame.description = `[Intégration Gardiens de but FootEco]\nMatch 7v7 avec grands buts. Les gardiens participent activement aux relances au pied et aux sorties aériennes.\n${result.finalGame.description}`;
